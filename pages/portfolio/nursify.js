...
class nursify extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <h3 className="title-detail"> Nursify: Academic Paper Writing Service </h3>
                <ul className="list">
                    <li className="list-inline-item h6 user text-muted">
                        {" "}
                        <span className="text-dark">Client:</span> Nursify.org
                    </li>
                    <li className="list-inline-item h6 date text-muted ml-2">
                        {" "}
                        <span className="text-dark">Date:</span>21 July 2021
                    </li>
                </ul>
                {/* </PageBreadcrumb> */}
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col xs={12} className="text-center">
                                <Image src={'/portfolio/essay/landing.jpg'} layout="intrinsic" width={1110} height={2060} className="img-fluid rounded" alt="Portfolio" />
                            </Col>
                                ...
                                <div className="bg-light rounded p-4">
                                    {
                                        <p className="text-muted font-italic mb-0">
                                            Nursify is a reputable online writing service provider Globally.We have always prioritized the aspect of working towards customer satisfaction and this is by giving them the good grades they are looking for. Nursing Class Essays has a team of tried and tested writers who have specialized in the different services that we offer. We at Nursing Class Essays have provided a conducive environment for our writers so that they can maximize their productivity and deliver that assignment no matter its deadline.
                                        </p>
                                    }
                                </div>
                                <Row>
                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/essay/1.jpg"} layout="intrinsic" width={445} height={300} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>

                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/essay/2.jpg"} layout="intrinsic" width={445} height={300} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>
                                </Row>
