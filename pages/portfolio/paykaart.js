...
class paykaart extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <h3 className="title-detail">Paykaart: Pay Your Way</h3>
                <ul className="list">
                    <li className="list-inline-item h6 user text-muted">
                        {" "}
                        <span className="text-dark">Client:</span> Dharma Co.
                    </li>
                    <li className="list-inline-item h6 date text-muted ml-2">
                        {" "}
                        <span className="text-dark">Date:</span>1 Dec 2020
                    </li>
                </ul>
                {/* </PageBreadcrumb> */}
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col xs={12} className="text-center">
                                <Image src={'/portfolio/playkaart/landing.jpg'} layout="intrinsic" width="1110px" height="1851px" className="img-fluid rounded" alt="Portfolio" />
                            </Col>
                            ...
                            <Col md={10} className="mt-4 pt-2">
                                <div className="bg-light rounded p-4">
                                    {
                                        <p className="text-muted font-italic mb-0">
                                            Website for an Online Payment App, let's you see all the features of the app and explore the functionality. Animations on the website makes it very unique and attractive
                                        </p>
                                    }
                                </div>
                                <Row>
                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/playkaart/1.jpg"} layout="intrinsic" width={445} height={300} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>

                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/playkaart/2.jpg"} layout="intrinsic" width={445} height={300} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>
                                </Row>
                                ...
                                <Row className="align-items-center">
                                    ...
                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/playkaart/main.jpg"} layout="intrinsic" width={445} height={333} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>
                                </Row>
