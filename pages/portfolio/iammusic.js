...
class iamMusic extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <h3 className="title-detail"> IamMusic: Music Teaching App </h3>
                <ul className="list">
                    <li className="list-inline-item h6 user text-muted">
                        {" "}
                        <span className="text-dark">Client:</span> Music Company
                    </li>
                    <li className="list-inline-item h6 date text-muted ml-2">
                        {" "}
                        <span className="text-dark">Date:</span>28 Sep 2020
                    </li>
                </ul>
                {/* </PageBreadcrumb> */}
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col xs={12} className="text-center">
                                <Image src={'/portfolio/work-2/landing.jpg'} layout="intrinsic" width={1110} height={3761} className="img-fluid rounded" alt="Portfolio" />
                            </Col>
                            ...
                            <Col md={10} className="mt-4 pt-2">
                                <div className="bg-light rounded p-4">
                                    {
                                        <p className="text-muted font-italic mb-0">
                                            Online Music Learning Portal. Teachers and Students can sign up and teach/learn via video conferencing. Teachers can list their courses and students can select their preferred course to start.
                                        </p>
                                    }
                                </div>
                                <Row>
                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/work-2/login.jpg"} layout="intrinsic" width={445} height={300} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>

                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/work-2/signup.jpg"} layout="intrinsic" width={445} height={300} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>
                                </Row>
                                ...
                                <Row className="align-items-center">
                                    ...
                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/portfolio-2.jpg"} layout="intrinsic" width={445} height={333} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>
                                </Row>
