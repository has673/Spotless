...
class burritoBar extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <h3 className="title-detail"> Burrito Bar: Food Ordering App </h3>
                <ul className="list">
                    <li className="list-inline-item h6 user text-muted">
                        {" "}
                        <span className="text-dark">Client:</span> Ben Perlmutter
                    </li>
                    <li className="list-inline-item h6 date text-muted ml-2">
                        {" "}
                        <span className="text-dark">Date:</span> 28 Aug 2020
                    </li>
                </ul>
                {/* </PageBreadcrumb> */}
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col xs={12} className="text-center">
                                <Image src={'/portfolio/work-1/burrito.jpg'} layout="intrinsic" width={1110} height={4585} className="img-fluid rounded" alt="Portfolio" />
                            </Col>
                            ...
                            <Col md={10} className="mt-4 pt-2">
                                <div className="bg-light rounded p-4">
                                    {
                                        <p className="text-muted font-italic mb-0">
                                            Food Ordering App for a restaurant located in San Francisco, California, United States. It let's you connect to the local server, see all the menu, select the food you want, with extras and option to remove ingredients. Users can pay through the online payment system integerated, i.e PayPal, Square, Stripe etc.
                                        </p>
                                    }
                                </div>
                                ...
                                <Row className="align-items-center">
                                    ...
                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"portfolio/work-1/portfolio-1.jpg"} layout="intrinsic" width={445} height={333} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>
                                </Row>
