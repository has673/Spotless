    ...
    render() {
        return (
            <React.Fragment>
                ...
                <h3 className="title-detail"> TrustBar: Crypto Wallet </h3>
                <ul className="list">
                    <li className="list-inline-item h6 user text-muted">
                        {" "}
                        <span className="text-dark">Client:</span> Mark Smith
                    </li>
                    <li className="list-inline-item h6 date text-muted ml-2">
                        {" "}
                        <span className="text-dark">Date:</span>15 June 2021
                    </li>
                </ul>
                {/* </PageBreadcrumb> */}
                    ...
                    <Container>
                        <Row className="justify-content-center">
                            <Col xs={12} className="text-center">
                                <Image src={'/portfolio/trust-bar/landing.jpg'} layout="intrinsic" width={1110} height={3528} className="img-fluid rounded" alt="Portfolio" />
                            </Col>
                            ...
                            <Col md={10} className="mt-4 pt-2">
                                ...
                                <Row className="align-items-center">
                                    ...
                                    <Col md={6} className="mt-4 pt-2">
                                        <Image src={"/portfolio/trust-bar/main.jpg"} layout="intrinsic" width={445} height={333} className="img-fluid rounded" alt="Portfolio" />
                                    </Col>
                                </Row>
