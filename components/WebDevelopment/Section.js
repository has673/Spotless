    ...
    return (
      <React.Fragment>
        <section
          ...
          style={{ background: `url(${bg}) center center`, padding:'200px 0' }}
          id="home"
        >
          <Container>
            <Row className="align-items-center">
              <Col lg={6} md={6}>
                ...
                <h1 className="heading font-weight-bold mt-2 mb-3">
                        ...
                        <Typist>
                          ...
                          <Typist.Backspace count={15} delay={400} />
                          <span className="element text-primary">Restaurants Websites</span>
                  ...
                  <p className="para-desc text-muted">
                    Get your website developed in the Modern stacks like React.js with Django.
                  </p>
              ...
              <Col lg={6} md={6} className="mt-4 pt-2 mt-sm-0 pt-sm-0">
                <Image src={seo} width="540px" height="350px" layout="intrinsic" className="img-fluid" alt="SEO" />
              </Col>
            </Row>
          </Container>
